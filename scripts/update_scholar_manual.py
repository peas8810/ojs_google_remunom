...
def main() -> None:
    ...
    payload = {
        "source": os.getenv(
            "SOURCE",
            "https://scholar.google.com/citations?hl=pt-BR&user=jgE3_sQAAAAJ&view_op=list_works",
        ),
        "profile_name": os.getenv("PROFILE_NAME", "REMUNOM (Google Scholar)"),
    ...
    print("OK: remunom-scholar.json atualizado via workflow manual.")
